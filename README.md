...
| v1.0 | 四路信源抓取 + 飞书推送 | ✅ |
| v1.1 | 直播间数据跟踪（官方旗舰店） | ✅ |
| v1.2 | 抖音达人直播数据抓取（多直播间并发监控） | ✅ |
| v1.3 | 带货数据路径分析（GMV/弹幕/商品点击） | ✅ |
| v2.0 | 多维度热度分析 + 趋势预测 | 🔄 |
...
| 能力 | 实现方式 | 备注 |
|------|---------|------|
| 抖音实时上升热点 | Playwright + API | Top20 |
| 微博热搜 | API 直连 | Top15 |
| B站全站热榜 | API 直连 | Top15 |
| 主流媒体 | RSS | Top5 |
| 抖音直播间监控 | Playwright API 拦截 | 舒肤佳+海飞丝 |
| 直播间数据分析 | 在线趋势/互动/稳定性 | 实时 |
| 直播话术分析 | 标题关键词提取 | 可升级弹幕 |
| 带货数据 | 部分可用 | GMV需企业API |
